...
class TrainValidImageDataset(Dataset):
    ...
    Args:
        ...
        lr_image_size (int): Low resolution image size.
        upscale_factor_list (list): Image up scale factor list.
    ...
    def __getitem__(self, batch_index: int) -> dict[str, Tensor]:
        ...
        # Crop small image size
        gt_image_width = int(self.lr_image_size * max(self.upscale_factor_list))
        gt_image_height = int(self.lr_image_size * max(self.upscale_factor_list))

        # Image processing operations
        if self.mode == "Train":
            gt_crop_image = imgproc.random_crop(gt_image, [gt_image_width, gt_image_height])
            ...
            gt_crop_image = imgproc.center_crop(gt_image, [gt_image_width, gt_image_height])
        else:
